        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-4 bg-blue-500 text-left text-sm font-medium text-white uppercase tracking-wider">Penanggung Jawab</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $kegiatan->nama }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $kegiatan->jenis }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $kegiatan->tanggal }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $kegiatan->tempat }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $kegiatan->penanggung_jawab }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div class="flex flex-row gap-x-2 justify-center">
                            ...
                            <button type="button"
                                data-url="{{ route('admin.kegiatan.destroy', $kegiatan->id) }}"
...
<div id="insertModal" class="hidden fixed inset-0 bg-black bg-opacity-50 bg-opacity-60 justify-center items-center">
    <div class="bg-white rounded-lg w-1/2">
        <form method="POST" action="{{ route('admin.kegiatan.store') }}" class="w-5/6 mx-auto my-5">
            @csrf
            <h2 class="text-center font-semibold text-lg text-black">Tambah Kegiatan Baru</h2><br>

            <div class="basis-1/2 mb-5">
                <label for="nama" class="block mb-2 text-sm font-medium text-black">Nama Kegiatan</label>
            ...
            <div class="basis-1/2 mb-5">
                <label for="jenis" class="block mb-2 text-sm font-medium text-black">Jenis Kegiatan</label>
            ...
            <div class="basis-1/2 mb-5">
                <label for="penanggung_jawab" class="block mb-2 text-sm font-medium text-black">Penanggung Jawab</label>
                <input name="penanggung_jawab" type="text" id="penanggung_jawab"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
...
@section('Edit Modal')
@foreach($kegiatans as $kegiatan)
<div id="editModal{{ $kegiatan->id }}" class="hidden fixed inset-0 bg-black bg-opacity-50 bg-opacity-60 justify-center items-center">
    <div class="bg-white rounded-lg w-1/2">
        <form method="POST" action="{{ route('admin.kegiatan.update', $kegiatan->id) }}" class="w-5/6 mx-auto my-5">
            @csrf
            @method('PUT')
            <h2 class="text-center font-semibold text-lg text-black">Edit Kegiatan</h2><br>

            <div class="basis-1/2 mb-5">
                <label for="nama" class="block mb-2 text-sm font-medium text-black">Nama Kegiatan</label>
                <input name="nama" type="text" id="nama" value="{{ $kegiatan->nama }}"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="jenis" class="block mb-2 text-sm font-medium text-black">Jenis Kegiatan</label>
                <input name="jenis" type="text" id="jenis" value="{{ $kegiatan->jenis }}"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="tanggal" class="block mb-2 text-sm font-medium text-black">Tanggal</label>
                <input name="tanggal" type="date" id="tanggal" value="{{ $kegiatan->tanggal }}"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="tempat" class="block mb-2 text-sm font-medium text-black">Tempat</label>
                <input name="tempat" type="text" id="tempat" value="{{ $kegiatan->tempat }}"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="lokasi" class="block mb-2 text-sm font-medium text-black">Lokasi</label>
                <input name="lokasi" type="text" id="lokasi" value="{{ $kegiatan->lokasi }}"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="penanggung_jawab" class="block mb-2 text-sm font-medium text-black">Penanggung Jawab</label>
                <input name="penanggung_jawab" type="text" id="penanggung_jawab" value="{{ $kegiatan->penanggung_jawab }}"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="basis-1/2 mb-5">
                <label for="deskripsi" class="block mb-2 text-sm font-medium text-black">Deskripsi</label>
                <textarea name="deskripsi" id="deskripsi" rows="4"
                    class="border ext-sm rounded-lg block w-full p-2 bg-gray-100 border-gray-50 placeholder-gray-400 text-black focus:ring-blue-500 focus:border-blue-500">{{ $kegiatan->deskripsi }}</textarea>
            </div>
            <div class="flex flex-row gap-3">
                <button type="submit"
                    class="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800 mb-5">Submit</button>
                <button type="button" onclick="closeEditModal('{{ $kegiatan->id }}')"
                    class="text-blue-600 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center bg-gray-100 hover:bg-gray-300 focus:ring-gray-600 mb-5">Cancel</button>
            </div>
        </form>
    </div>
