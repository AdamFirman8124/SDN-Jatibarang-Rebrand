...
<html lang="id">
  <head>
    ...
    <title>Buku Pembelajaran Kelas 2 - SDN Jatibarang 02</title>
    <link
      rel="icon"
  ...
  <body>
    ...
    <section class="buku">
      <div class="container">
        <h1>Buku Pembelajaran Kelas 2</h1>
        ...
        <div class="buku-grid">
          <div class="buku-card" data-category="tematik">
            ...
            >
              <img
                ...
                alt="Buku Tematik 1 Kelas 2"
              />
            </div>
            <div class="buku-detail">
              <h2>Buku Tematik 1: Hidup Rukun</h2>
              ...
              <div class="buku-actions">
                <a href="{{ asset('assets/buku/tematik1-kelas2.pdf') }}" class="btn" download
                  ><i class="fas fa-download"></i> Unduh</a
                >
                <a
                  href="{{ asset('assets/buku/tematik1-kelas2.pdf') }}"
                  class="btn"
                  target="_blank"
          ...
          <div class="buku-card" data-category="tematik">
            ...
            >
              <img
                src="{{ asset('assets/images/tematik-kelas2-tema2.png') }}"
                alt="Buku Tematik 2 Kelas 2"
              />
            </div>
            <div class="buku-detail">
              <h2>Buku Tematik 2: Bermain di Lingkunganku</h2>
              <p><strong>Pengarang:</strong> Kemendikbud</p>
              <p><strong>Penerbit:</strong> Pusat Kurikulum dan Perbukuan</p>
              <p><strong>Tahun:</strong> 2023</p>
              <div class="buku-actions">
                <a href="{{ asset('assets/buku/tematik2-kelas2.pdf') }}" class="btn" download
                  ><i class="fas fa-download"></i> Unduh</a
                >
                <a
                  href="{{ asset('assets/buku/tematik2-kelas2.pdf') }}"
                  class="btn"
                  target="_blank"
                  ><i class="fas fa-eye"></i> Baca Online</a
                >
          ...
          <div class="buku-card" data-category="matematika">
            ...
            >
              <img
                ...
                alt="Buku Matematika Kelas 2"
              />
            </div>
            <div class="buku-detail">
              <h2>Matematika untuk SD Kelas 2</h2>
              <p><strong>Pengarang:</strong> Drs. Ahmad Fauzi, M.Pd.</p>
              <p><strong>Penerbit:</strong> Erlangga</p>
              <p><strong>Tahun:</strong> 2022</p>
              <div class="buku-actions">
                <a href="{{ asset('assets/buku/matematika-kelas2.pdf') }}" class="btn" download
                  ><i class="fas fa-download"></i> Unduh</a
                >
                <a
                  href="{{ asset('assets/buku/matematika-kelas2.pdf') }}"
                  class="btn"
                  target="_blank"
                  ><i class="fas fa-eye"></i> Baca Online</a
                >
          ...
          <div class="buku-card" data-category="bahasa">
            ...
            >
              <img
                ...
                alt="Buku Bahasa Indonesia Kelas 2"
              />
            </div>
            <div class="buku-detail">
              <h2>Bahasa Indonesia untuk SD Kelas 2</h2>
              <p><strong>Pengarang:</strong> Dra. Siti Aminah, M.Pd.</p>
              <p><strong>Penerbit:</strong> Yudhistira</p>
              <p><strong>Tahun:</strong> 2021</p>
              <div class="buku-actions">
                <a
                  href="{{ asset('assets/buku/bahasa-indonesia-kelas2.pdf') }}"
                  class="btn"
                  download
                  ><i class="fas fa-download"></i> Unduh</a
                >
          ...
          <div class="buku-card" data-category="agama">
            ...
            >
              <img
                src="{{ asset('assets/images/buku-pai-kelas2.png') }}"
                alt="Buku PAI Kelas 2"
              />
            </div>
            <div class="buku-detail">
              <h2>Pendidikan Agama Islam Kelas 2</h2>
              <p><strong>Pengarang:</strong> Tim Penyusun Kemenag</p>
              <p><strong>Penerbit:</strong> Kementerian Agama</p>
              <p><strong>Tahun:</strong> 2023</p>
              <div class="buku-actions">
                <a href="{{ asset('assets/buku/pai-kelas2.pdf') }}" class="btn" download
                  ><i class="fas fa-download"></i> Unduh</a
                >
                <a href="{{ asset('assets/buku/pai-kelas2.pdf') }}" class="btn" target="_blank"
                  ><i class="fas fa-eye"></i> Baca Online</a
                >
              </div>
            </div>
        ...
        <div class="video-pembelajaran">
          <h2>Video Pembelajaran Kelas 2</h2>
          <div data-aos="fade-up" data-aos-duration="600" class="video-grid">
            ...
            <div class="video-card">
              ...
              <h3>Membaca dan Menulis Kalimat</h3>
